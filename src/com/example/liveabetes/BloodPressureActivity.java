...
public class BloodPressureActivity extends Activity {
	...
	private PressureDatabaseHandler db;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_insulin);
		db = new PressureDatabaseHandler(this);
	...
	//Submit button
		public void submit(View view) {
			...
			System.out.println(stringDate + ":" + stringTime + ":" + stringPressure);

			//Local Database
			Log.d("Insert: ", "Inserting .."); 
			db.addEntry(new Entry(timeCode, stringPressure));        

			Log.d("Reading: ", "Reading all contacts.."); 
			List<Entry> contacts = db.getAllEntries();       

			for (Entry cn : contacts) {
				String log = "Id: "+cn.getID()+", Date: " + cn.getTimecode() + ", Blood Pressure: " + cn.getValue();
