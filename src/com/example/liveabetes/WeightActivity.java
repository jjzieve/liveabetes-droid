...
public class WeightActivity extends Activity {
	...
	private WeightDatabaseHandler db;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_insulin);
		db = new WeightDatabaseHandler(this);
	...
	//Submit button
		public void submit(View view) {
			...
			System.out.println(stringDate + ":" + stringTime + ":" + stringWeight);

			//Local Database
			Log.d("Insert: ", "Inserting .."); 
			db.addEntry(new Entry(timeCode, stringWeight));        

			Log.d("Reading: ", "Reading all contacts.."); 
			List<Entry> contacts = db.getAllEntries();       

			for (Entry cn : contacts) {
				String log = "Id: "+cn.getID()+", Date: " + cn.getTimecode() + ", Weight: " + cn.getValue();
