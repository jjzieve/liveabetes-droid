...
public class InsulinDatabaseHandler extends SQLiteOpenHelper {
	...
	private static final String DATABASE_NAME = "insulinManager";
	...
	public InsulinDatabaseHandler(Context context) {
